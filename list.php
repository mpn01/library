...
<body>
    <div id="list">
        ...
        <center><h1 class="global_title">Home library</h1></center>
        <?php
            try {
                ...
                if (mysqli_connect_error() != 0){
                    ...
                    if($_GET["s"] == ""){
                        ...
                        echo "<center><h2 class='global_subtitle'>Books of genre "."<span class='bluebg'>".$genre."</span>"."</h2> </center>";
                    }
                    ...
                    if($_GET["g"] == "") {
                        ...
                        echo "<center><h2 class='global_subtitle'>Books which contains the: &raquo".$search."&laquo</h2></center>";
                    }
                    ...
                    if(($_GET["s"] && $_GET["g"]) != "") {
                        ...
                        echo "<center><h2 class='global_subtitle'>Books which contains the: &raquo".$search."&laquo where genre is: <span class='bluebg'>".$genre."</span></h2></center>";
                    }

                    $result = $conn->query($query);

                    while(($row = $result -> fetch_assoc()) != 0) {
                        echo "<div onclick='showInfo(".$row['id'].",1)' class='item'>";
                            echo $row['id'];
                            echo "<h2 class='title'>";
                                echo $row['title'];
                                echo " ";
