...
<body>
    <div id="list">
        ...
        <h1 class="list_title">Home library</h1>
        <?php
            try {
                ...
                if (mysqli_connect_error() != 0){
                    ...
                    if($_GET["s"] == ""){
                        ...
                        echo "<center><h2 class='list_subtitle'>Books of genre "."<span class='list_subtitle_highlight'>".$genre."</span>"."</h2> </center>";
                    }
                    ...
                    if($_GET["g"] == "") {
                        ...
                        echo "<center><h2 class='list_subtitle'>Books which contains the: &raquo".$search."&laquo</h2></center>";
                    }
                    ...
                    if(($_GET["s"] && $_GET["g"]) != "" && strlen($_GET["s"]) > 2) {
                        ...
                        echo "<center><h2 class='list_subtitle'>Books which contains the: &raquo".$search."&laquo where genre is: <span class='list_subtitle_highlight'>".$genre."</span></h2></center>";
                    }
        ...
        <div class="list_item">
            ...
            <h3 class="list_item_author">
                <?php if($row['other_authors'] !== ""){ echo $row['author'].", ".$row['other_authors']; } else { echo $row['author'];}?>
            </h3>
            <div id="<?php $row['id'];?>" class="list_item_info">
                Pages: <?php echo $row['pages'];?>
                <?php
                    if ($row['first_release'] == 0){ echo "";} else { echo "| First release: " . $row['first_release'];}
